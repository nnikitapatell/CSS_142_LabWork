...
public class TODO1 extends SpaceSmasherFunctionalAPI {
    ...
    //this function should check for collisions and handles them by calling the functions below
    public void paddleBallCollisionCheck(){
         if(ballCollidedWithPaddle()){
            ballReflectOffPaddle();         //call this function to make the ball reflect off of the paddle after a collision
            ballPlayBounceSound();          //call this function to make a bounce sound associated with the ball();
         }
    }
}
